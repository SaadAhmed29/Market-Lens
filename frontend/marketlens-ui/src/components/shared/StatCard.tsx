        ...
        <Card className={cn("relative overflow-hidden group/stat border-border", className)}>
            ...
            <CardContent className="p-4 flex flex-col justify-between h-full relative z-10">
                <div className="flex flex-col gap-1">
                    <span className="text-[0.65rem] font-mono uppercase tracking-[0.2em] text-muted-foreground flex items-center gap-1">
                        <span className="text-accent">&gt;</span> {label}
                    </span>
                    <span className="text-2xl font-mono tracking-tight text-foreground mt-1">
                        {value}
                    </span>
                </div>
